...
function handleMethodChange() {
  ...
  document.getElementById("payment-button-isp").style.display = "none";
  document.getElementById("payment-button-recurring").style.display = "none";
  document.getElementById("payment-button-seapay").style.display = "none";
  ...
  } else if (method === "vnpay-recurring") {
    document.getElementById("payment-button-recurring").style.display = "inline-block";
  } else if (method === "seapay") {
    document.getElementById("payment-button-seapay").style.display = "inline-block";
  }
}
